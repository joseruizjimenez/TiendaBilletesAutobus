			...
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post" align="center">
                      <h2 class="title">Gestion del billete</h2>
                      ...
                      <p>Seleccione una operacion para el billete</p>
                      <h3><a href="/TiendaBilletesAutobus/go?to=informacion" style="color: blue;">Mostrar informacion e imprimir</a></h3></br>
                      <h3><a href="/TiendaBilletesAutobus/go?to=emailFactura" style="color: blue;">Reenviar factura por email</a></h3></br>
                      <h3><a href="/TiendaBilletesAutobus/go?to=cancelMenu" style="color: blue;">Cancelar billete</a></h3></br>
                      <h3><a href="/TiendaBilletesAutobus/go?to=cambioCheck" style="color: blue;">Cambiar billete</a></h3></br>
                      <p></p>

                      <a href="/TiendaBilletesAutobus/go?to=cancelado" style="color: #2EB902; font-size: 16px;">SALIR DEL MENU</a>
