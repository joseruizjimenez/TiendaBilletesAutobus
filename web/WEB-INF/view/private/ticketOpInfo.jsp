			...
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post" align="center">
                      <h2 class="title">Informacion del billete</h2>
                      ...
                      Factura factura = billeteGestion.getFactura();
                      Ruta ruta = billeteGestion.getServicio().getRuta();%>
                      <p style="text-decoration: underline;">Datos de la <b>factura</b> de compra:</p>
                      <p style="margin-bottom: 0px;"><b>Localizador</b>: <%=billeteGestion.getLocalizador()%></p>
                      <p style="margin-bottom: 0px;"><b>Origen</b>: <%=ruta.getOrigen()%></p>
                      <p style="margin-bottom: 0px;"><b>Destino</b>: <%=ruta.getDestino()%></p>
                      <p style="margin-bottom: 0px;"><b>Nombre viajero</b>: <%=billeteGestion.getNombreViajero()%></p>
                      <p style="margin-bottom: 0px;"><b>NIF viajero</b>: <%=billeteGestion.getDniViajero()%></p>
                      <p style="margin-bottom: 0px;"><b>Plaza</b>: <%=billeteGestion.getNumAsiento()%></p>
                      <p style="margin-bottom: 0px;"><b>Nombre cliente</b>: <%=factura.getNombreComprador()%></p>
                      <p style="margin-bottom: 0px;"><b>NIF cliente</b>: <%=factura.getDNI()%></p>
                      <p style="margin-bottom: 0px;"><b>Email</b>: <%=factura.getEmail()%></p>
                      <p style="margin-bottom: 0px;"><b>Num. movil</b>: <%=factura.getMvl()%></p>
                      <p style="margin-bottom: 0px;"><b>Tarjeta de pago</b>: <%=factura.getNumTarjeta()%></p>
                      <p style="margin-bottom: 0px;"><b>Fecha de la compra</b>: <%=factura.getTransactionDateAsString()%></p>
                      <p><b>Precio billete</b>: <%=billeteGestion.getServicio().getPriceAsFormattedString()%></p></br>
                      <p>Si desea imprimir la factura pulse: Ctrl+P</p>
                      <p></p>
