			...
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post" align="center">
                      <h2 class="title">Pago realizado con exito</h2>
                      ...
                      BilleteVendido billete = billetesReservadosC.get(0);%>
                      <p>Datos de la <b>factura</b> de compra:</p></br>
                      <p><b>Localizador</b>: <%=billete.getLocalizador()%></p>
                      <p><b>Nombre cliente</b>: <%=factura.getNombreComprador()%></p>
                      <p><b>NIF cliente</b>: <%=factura.getDNI()%></p>
                      <p><b>Email</b>: <%=factura.getEmail()%></p>
                      <p><b>Num. movil</b>: <%=factura.getMvl()%></p>
                      <p><b>Tarjeta de pago</b>: <%=factura.getNumTarjeta()%></p>
                      <p><b>Fecha de la compra</b>: <%=factura.getTransactionDateAsString()%></p>
                      <p><b>Precio total</b>: <%=factura.getTotalAsFormattedString()%></p></br>
                      <p>Si desea imprimir la factura pulse: Ctrl+P</p>
                      <p></p>
                      <a href="/TiendaBilletesAutobus/" style="color: #2EB902; font-weight: bold;">VOLVER</a>
