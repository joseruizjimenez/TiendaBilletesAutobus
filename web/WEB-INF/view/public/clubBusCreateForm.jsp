		...
		<div id="header">
			...
			<div id="menu">
				<ul>
					...
					<li class="current_page_item"><a href="/TiendaBilletesAutobus/go?to=solicitudClubBus">solicitar tarjeta club-bus</a></li>
			...
			<div id="page-bgbtm">
				<div id="content">
				  <div class="post" align="center">
                      <h2 class="title">Solicitar tarjeta Club Bus</h2>
                      ...
                      <form method="post" action="/TiendaBilletesAutobus/go">
                            <input name="to" value="solicitudAplicada" type="hidden">
                            <%HashMap<UUID,Servicio> serviciosC = (HashMap<UUID,Servicio>) servicios;%>
                            <p>Rellene los siguientes datos para solicitar su tarjeta:</p>
                            <p style="color: blue; text-align: right; padding-right: 240px;">
                                Nombre <input name="nombreComprador" value="" type="text" /></br>
                                Apellidos <input name="nombrddeComprador" value="" type="text" /></br>
                                NIF/Pasaporte <input name="DNI" value="" type="text" /></br>
                                Sexo <select name="fechaaaa"><option>Hombre</option><option>Mujer</option></select></br>
                                Fecha de nacimiento <select name="day"><%for(int i=1;i<=31;i++){%><option><%=i%></option><%}%></select>&nbsp;<select name="month">
                                    <%for(int i=1;i<=12;i++) {%><option><%=i%></option><%}%></select>&nbsp;<select name="year">
                                    <%for(int i=2012;i<2015;i++) {%><option><%=i%></option><%}%></select></br>
                                Pais de nacimiento <input name="DNId" value="" type="text" /></br>
                                Email <input name="email" value="" type="text" /></br>
                                Num. movil <input name="mvl" value="" type="text" /></br>
                                Direccion de envio <input name="DasdNI" value="" type="text" /></br>
                                Poblacion <input name="poblacion" value="" type="text" /></br>
                                Provincia <input name="provincia" value="" type="text" /></br>
                                Codigo postal <input name="codigoPostal" value="" type="text" /></br></br>
                                Acepto el reglamento de la tarjeta Club Bus <input type="checkbox" name="sfecha" value="sinfecha"></br>
                                Acepto la politica de privacidad <input type="checkbox" name="sfddecha" value="sinfecha"></br>
                                Deseo recibir publicidad con ofertas <input type="checkbox" name="svvcha" value="sinfecha" checked>
                            </p>
                            <p></p>
